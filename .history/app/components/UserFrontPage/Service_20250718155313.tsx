        ...
        <Row gutter={16} justify="center">
          ...
          <Col span={6}>
            ...
            >
              <div className="mb-4">
                <Image
                  src="/assets/logos/trustpilot-logo.png"
                  alt="Trustpilot"
                  width={120}
                  height={40}
                  className="mx-auto mb-3"
          ...
          <Col span={6}>
            ...
            >
              ...
              <p className="text-gray-600 mb-4 text-left">
                "Tôi đã sử dụng nhiều hệ thống quản lý khách sạn nhưng đây là hệ
                thống tốt nhất. Đáng tin cậy và dễ sử dụng."
              </p>
          ...
          <Col span={6}>
            ...
            >
              <div className="mb-4">
              <img loading="lazy" decoding="async" src="https://resources.littlehotelier.com/images/credibility/logo-hoteltechreport.svg" width="127" height="41" alt="">
              </div>
              <p className="text-xl font-semibold text-gray-800 mb-4">
                "Tuyệt vời!"
              </p>
