        ...
        <Row gutter={16} justify="center">
          <Col span={8}>
            <Card
              ...
              style={{ height: "100%" }}
            >
              <p className="text-xl text-left font-semibold text-gray-800 mb-4">
                "Dịch vụ tuyệt vời!"
              </p>
          ...
          <Col span={8}>
            ...
            >
              ...
              <p className="text-gray-600 mb-4">
                "Tôi đã sử dụng nhiều hệ thống"
              </p>
              <p className="text-gray-600 mb-4">
                quản lý khách sạn nhưng đây là hệ thống tốt nhất. Đáng tin cậy
                và dễ sử dụng."
              </p>
