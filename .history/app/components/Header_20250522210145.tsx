    ...
    <div className="py-4 px-6 mx-auto container">
      <div className="flex flex-row justify-around">
        <div className="flex gap-2 items-center w-full md:2/3">
          ...
          <MdLightMode className="absolute h-10 w-10 rotate-90 scale-100 dark:-rotate-0 dark:scale-100" />
          {theme === "dark" ? (
            <MdModeNight className="h-10 w-10 rotate-0 scale-100 dark:-rotate-90 dark:scale-0" />
          ) : (
            <MdLightMode className="h-10 w-10 rotate-90 scale-0 dark:-rotate-0 dark:scale-100" />
          )}
        </div>
      ...
      <div className="mt-4">
        <ul className="flex flex-row">
          <li className="px-2 hover:">Khách Sạn</li>
