    ...
    <section className="flex px-4 items-center gap-12 container mx-auto">
      ...
      <div className="py-10 h-full grid grid-cols-1 lg:grid-cols-2 gap-6">
        <h1 className="font-medium md:font-semibold md:text-6xl text-3xl">
          ...
          <br />
          <span className="headingpad__introduce-text">Miễn phí</span> & Tăng cường kinh doanh của bạn với hệ thống quản
          lý tài sản tất cả trong một miễn phí
        </h1>
        <p className="text-sm">
          Dễ dàng quản lý tài sản của bạn và tăng cường kinh doanh của bạn với các công cụ mạnh mẽ và dễ sử dụng.
        </p>
        <div className="flex items-center gap-4 mt-6">
          <button className=" text-white px-6 py-2 rounded-lg transition-colors">Tạo trang web miễn phí</button>
