...
import { Home, AlertCircle, CalendarCheck } from "lucide-react";
        ...
        <CardContent className="pt-6">
          <div className="flex flex-col items-center text-center space-y-4">
            ...
            <div className="flex flex-col sm:flex-row gap-3 pt-4 w-full">
              ...
              <Button variant="outline" className="flex-1" onClick={() => router.push("/hotelreception/bookings")}>
                <CalendarCheck className="size-4 mr-2" />
                {t("holding_page_bookings_button")}
              </Button>
            </div>
          </div>
        </CardContent>
